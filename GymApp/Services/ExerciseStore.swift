...
final class ExerciseStore {
    ...
    func seedIfNeeded() {
        ...
        for (name, desc, type, primary, secondary, equipment, blockType, pattern) in Self.builtInExercises {
    ...
    private static let builtInExercises: [(String, String, ExerciseType, [MuscleGroup], [MuscleGroup], Equipment, BlockType, MovementPattern?)] = [
        ...
        ("Reverse Lunges", "Step-back lunge variation", .strength, [.quads, .glutes], [.hamstrings], .none, .repBased, .squat),
        ("Walking Lunges", "Forward stepping lunge pattern", .strength, [.quads, .glutes], [.hamstrings, .core], .none, .repBased, .squat),
        ("Bulgarian Split Squats", "Rear foot elevated single-leg squat", .strength, [.quads, .glutes], [.hamstrings, .core], .none, .repBased, .squat),
        ("Step-ups", "Step onto elevated surface", .strength, [.quads, .glutes], [.hamstrings], .none, .repBased, .squat),
        ...
        ("Hip Thrusts", "Loaded hip extension for glutes", .strength, [.glutes], [.hamstrings, .core], .none, .repBased, .hinge),
        ("Tricep Dips", "Bodyweight tricep exercise", .strength, [.triceps], [.chest, .shoulders], .none, .repBased, .push),
        ("Inverted Rows", "Bodyweight horizontal pull", .strength, [.back, .biceps], [.core, .forearms], .none, .repBased, .pull),
        ...
        ("Crunches", "Basic abdominal flexion", .strength, [.core], [], .none, .repBased, nil),
        ...
        ("Dead Bugs", "Anti-extension core stability drill", .strength, [.core], [], .none, .repBased, nil),
        ...
        ("Hollow Body Hold", "Gymnastic core position", .isometric, [.core], [], .none, .timed, nil),
        ("L-Sit", "Advanced isometric core hold", .isometric, [.core, .hipFlexors], [.triceps], .none, .timed, nil),
        ("Glute Bridge Hold", "Isometric hip extension hold", .isometric, [.glutes, .hamstrings], [.core], .none, .timed, nil),
        ...
        ("Incline Bench Press", "Upper chest focused press", .strength, [.chest, .shoulders], [.triceps], .barbell, .repBased, .push),
        ...
        ("Hip Thrust (Barbell)", "Loaded hip extension for glutes", .strength, [.glutes], [.hamstrings, .core], .barbell, .repBased, .hinge),
        ...
        ("Dumbbell Bench Press", "Chest press with dumbbells", .strength, [.chest, .triceps], [.shoulders], .dumbbell, .repBased, .push),
        ...
        ("Dumbbell Row", "Single-arm back row", .strength, [.back, .biceps], [.forearms], .dumbbell, .repBased, .pull),
        ...
        ("Dumbbell Romanian Deadlift", "Dumbbell hip hinge for hamstrings", .strength, [.hamstrings, .glutes], [.back], .dumbbell, .repBased, .hinge),
        ("Farmer's Walk", "Loaded carry for grip and core", .strength, [.forearms, .core], [.traps, .shoulders], .dumbbell, .timed, .carry),
        ...
        ("Cable Row", "Seated horizontal cable pull", .strength, [.back, .biceps], [.forearms], .cableMachine, .repBased, .pull),
        ...
        ("Leg Press", "Machine-based lower body press", .strength, [.quads, .glutes], [.hamstrings], .legPress, .repBased, .squat),
        ("Leg Extension", "Quad isolation machine", .strength, [.quads], [], .other, .repBased, nil),
        ("Leg Curl", "Hamstring isolation machine", .strength, [.hamstrings], [], .other, .repBased, nil),
        ("Seated Calf Raise", "Machine calf isolation", .strength, [.calves], [], .other, .repBased, nil),
        ("Hip Abduction Machine", "Outer thigh and glute med", .strength, [.glutes], [], .other, .repBased, nil),
        ("Hip Adduction Machine", "Inner thigh isolation", .strength, [.quads], [], .other, .repBased, nil),
        ("Chest Press Machine", "Machine-guided chest press", .strength, [.chest, .triceps], [.shoulders], .other, .repBased, .push),
        ("Shoulder Press Machine", "Machine-guided overhead press", .strength, [.shoulders, .triceps], [], .other, .repBased, .push),
        ...
        ("Banded Squat", "Squat with band resistance", .strength, [.quads, .glutes], [.hamstrings], .resistanceBand, .repBased, .squat),
        ("Banded Lateral Walk", "Glute med activation drill", .strength, [.glutes], [], .resistanceBand, .repBased, nil),
